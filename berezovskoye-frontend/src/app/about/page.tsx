        ...
        <div className="flex w-full max-w-screen-lg flex-col gap-2 py-2 sm:gap-4 sm:py-4">
            ...
            <div className="flex flex-col gap-1 bg-white p-1 sm:gap-2.5 sm:p-2.5">
                ...
                <div className="flex flex-col gap-2">
                    <p>
                        Торфопредприятие «Березовское» создано <span className="font-bold">29 декабря 1960</span> года
                    ...
                    <p>
                        В <span className="font-bold">1981 году</span> Приказом Министерства топливной промышленности
                    ...
                    <p>
                        Место строительства завода было выбрано в <span className="font-bold">районе д.Нехачево и
                        ...
                        ремонтное и складское хозяйство, а <span className="font-bold">с 1986 года</span>, в связи
            ...
            <div className="flex flex-col items-center justify-center gap-1 bg-white p-1 sm:gap-2.5 sm:p-2.5 md:flex-row">
                ...
                <div className="flex flex-col gap-2">
                    <p>
                        В <span className="font-bold">1987 году</span> был введен в действие новый брикетный завод.
                        ...
                        <span className="font-bold"> 60 тысяч тонн в год.</span>
                    </p>
                    <p>
                        В <span className="font-bold">1992 году</span>, в связи с выработкой сырьевых запасов
                    ...
                    <p>
                        В <span className="font-bold">2001 году</span> торфопредприятие «Березовское» решением концерна
            ...
            <div className="flex flex-col items-center justify-center gap-1 bg-white p-1 sm:gap-2.5 sm:p-2.5 md:flex-row-reverse">
                ...
                <div className="flex flex-col gap-2">
                    <p>
                        В <span className="font-bold">2007 году</span> на основании приказа Министерства энергетики
                        РБ №199 от 29 июня 2007 года, приказа ПРУП «Брестоблгаз» №571 от
                        <span className="font-bold"> 24.07.2007 г.</span> создано торфобрикетное производственное
                    ...
                    <p>
                        ...
                        <span className="font-bold"> Министерство энергетики РБ.</span> УП «Брестоблгаз» входит в
